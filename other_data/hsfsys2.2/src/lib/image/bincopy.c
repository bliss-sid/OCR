/*
# proc: binary_subimage_copy_8 - copies a binary subimage that is a multiple
# proc:                          of 8 bits wide.
# proc: binary_subimage_copy_gt - special condition when copying a
# proc:                           binary subimage.
# proc: binary_subimage_copy_lt - special condition when copying a
# proc:                           binary subimage.
# proc: binary_subimage_copy_eq - special condition when copying a
# proc:                           binary subimage.
# proc: binary_subimage_copy - copies a binary subimage to another image
# proc:                        at a specified location.
*/
