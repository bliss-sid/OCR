...
*				  lines, and the compressed data.   *
********************************************************************/
void control_decompression( compressed, decompressed )
struct compressed_descriptor *compressed;
struct decompressed_descriptor *decompressed;
{
...
*				  lines, and the compressed data.   *
********************************************************************/
void read_compressed_file_into_memory(compressed)
struct compressed_descriptor *compressed;
{

     if(decomp_alloc_flag){
 	if((compressed->data = (char *)calloc(compressed->length_in_bytes, sizeof(char))) == NULL) {
...
********************************************************************/
void prepare_to_decompress( compressed, decompressed, params )
struct compressed_descriptor 	*compressed;
struct decompressed_descriptor  *decompressed;
...
*			    for comparison and other tasks.         *
********************************************************************/
void set_up_first_line_d( params )
struct parameters *params;
{
...
*			    for comparison and other tasks.         *
********************************************************************/
void set_up_first_and_last_changing_elements_d(params)
struct parameters *params;
{
	*(params->coding_line) = Invalid;
...
*			    for comparison and other tasks.         *
********************************************************************/
void prepare_to_decompress_next_line( params )
struct parameters *params;
{
...
*			    for comparison and other tasks.         *
********************************************************************/
void swap_the_reference_and_coding_lines( params )
struct parameters *params;
{
SHORT *temp;
...
******************************************************************************/
void vertical_mode_d(params, offset)
struct parameters *params;
SHORT offset;
{
SHORT run_length;
...
******************************************************************************/	
void prepare_to_write_bits_d( output_pointer, bytes_per_line )
char *output_pointer;
...
******************************************************************************/	void write_bits_d(length, color)
...
******************************************************************************/	void prepare_to_read_bits( input_pointer )
char *input_pointer;
{
...
******************************************************************************/	SHORT find_run_length_code(color)
